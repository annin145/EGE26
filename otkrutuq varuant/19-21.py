...
#
# print('19)', [x for x in range(1,143) if (x,11,2)])
# print('20)', [x for x in range(1,143) if (x,11,3) and not f(x,11,1)])
# print('21)', [x for x in range(1,143) if (x,11,4) and not f(x,11,2)])
